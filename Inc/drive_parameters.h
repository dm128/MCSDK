...
#define MAX_APPLICATION_SPEED_RPM       33000 /*!< rpm, mechanical */
...
#define PLL_KP_GAIN                      2195
#define PLL_KI_GAIN                      97
...
#define PID_TORQUE_KP_DEFAULT         3614
#define PID_TORQUE_KI_DEFAULT         925
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2158
#define PID_FLUX_KI_DEFAULT           925
...
#define PID_SPEED_KP_DEFAULT          2321/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          76/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define IQMAX_A                          28.38984446534401

/* Default settings */
#define DEFAULT_CONTROL_MODE           MCM_SPEED_MODE
#define DEFAULT_TARGET_SPEED_RPM       11880
#define DEFAULT_TARGET_SPEED_UNIT      (DEFAULT_TARGET_SPEED_RPM*SPEED_UNIT/U_RPM)
#define DEFAULT_TORQUE_COMPONENT_A       0
#define DEFAULT_FLUX_COMPONENT_A         0

/**************************    FIRMWARE PROTECTIONS SECTION   *****************/
#define OV_VOLTAGE_THRESHOLD_V          26 /*!< Over-voltage
                                                         threshold */
...
#define PHASE1_FINAL_CURRENT_A           30
/* Phase 2 */
#define PHASE2_DURATION                26400 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT         (13200*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A           30
/* Phase 3 */
#define PHASE3_DURATION                0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (13200*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A           30
/* Phase 4 */
#define PHASE4_DURATION                0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (13200*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A           30
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (13200*SPEED_UNIT/U_RPM)
#define PHASE5_FINAL_CURRENT_A           30

#define ENABLE_SL_ALGO_FROM_PHASE      2
/* Sensor-less rev-up sequence */
#define STARTING_ANGLE_DEG             0  /*!< degrees [0...359] */
/* Observer start-up output conditions  */
#define OBS_MINIMUM_SPEED_RPM          11880
...
#define M1_CONSTANT1_Q                 339127
#define M1_CONSTANT1_D                 202458
#define M1_CONSTANT2_QD                20836
/*  Maximum Torque Per Ampere strategy parameters */

#define MTPA_ENABLING
#define SEGDIV                         1931
#define M1_ANGC                        {-1578,-4681,-7704,-10481,-13066,-15366,-17427,-19216}
#define OFST                           {0,182,539,1030,1639,2317,3046,3784}
