...
#define RESISTOR_OFFSET                        0.181  /* computed resitance offset to compensate error meaasuremnt due to board*/
...
#define DC_CURRENT_RS_MEAS                     ((30) * 80) / 100 /* Maximum level of direct current = 80% of Max Board current */
...
#define M1_HALL_IC_FILTER                      LL_TIM_IC_FILTER_FDIV16_N8
