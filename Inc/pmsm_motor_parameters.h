...
#define LS                      0.000117 /* Stator inductance, H
...
#define MOTOR_MAX_SPEED_RPM     33000 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  0.9 /*!< Volts RMS ph-ph /kRPM */
#define NOMINAL_CURRENT_A       30

#define ID_DEMAG_A              (int16_t)-30 /*!< Demagnetization current */
